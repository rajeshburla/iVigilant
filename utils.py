# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 18:51:03 2019
...
def set_working_directory():
    ...
    print('Current date and time: %s', datetime.today())
    print('Computer and user name: %s, %s', os.getenv('COMPUTERNAME'), os.getlogin())
    ...
    # Log the script path
    print('Main scope script path: %s', script_path)
    ...
    if os.getcwd() == project_directory:
        print('Current working directory = Project directory'
                    '\n')
    else:
        print('Changing working directory from: %s', os.getcwd())
